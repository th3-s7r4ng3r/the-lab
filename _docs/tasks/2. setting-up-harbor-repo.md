...
- Harbor will be used to store Docker images built from Jenkins pipelines, as well as publically pulled images are stored here as for safe keeping and as a cache. 
...
2. **Create a New Project**:
   ...
   - Enter a name for the project (e.g., `the-lab-repo`).
...
4. **Create Service Account**:
   - To allow Jenkins to push images to Harbor, create a service account:
     ...
     - Open the project settings and assign the user to the `the-lab-repo` project with appropriate permissions (e.g., Developer or Maintainer).
